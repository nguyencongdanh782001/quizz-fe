    ...
    return (
      <div className={cn("space-y-1.5", className)}>
        ...
        >
          ...
          <PopoverContent className="w-[280px] p-2.5 rounded-[10px] shadow-xl border-[#CBD5E1] bg-white">
            <div className="flex items-center justify-between gap-2 px-1">
              <p className="font-bold text-xs text-[#1E293B]">Chọn ngày sinh</p>
              <div className="flex items-center gap-1">
                <Button
                  type="button"
                  variant="outline"
                  size="icon-sm"
                  className="h-6.5 w-6.5 rounded-md p-0"
            ...
            <div className="mt-2 rounded-[6px] bg-[#F8FAFC] p-1.5 border border-[#E2E8F0]">
              <div className="grid grid-cols-2 gap-1.5">
                <div className="space-y-1">
                  <label
                    htmlFor={`${inputId}-month`}
                    className="text-[10px] font-bold uppercase tracking-wider text-[#64748B]"
                  >
                    Tháng
                  </label>
                  <Select
                  ...
                  >
                    <SelectTrigger
                      ...
                      className="h-7 rounded-[4px] text-xs font-medium bg-white px-2"
                    >
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent
            ...
            <div className="mt-2 grid grid-cols-7 gap-0.5 text-center text-[10px] font-bold uppercase tracking-wider text-[#64748B]">
            ...
            <div
              className="mt-0.5 grid grid-cols-7 gap-0.5 place-items-center"
              aria-label="Lịch chọn ngày sinh"
            >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "bg-[#6366F1] font-bold text-white shadow-xs"
                        : "text-[#1E293B] hover:bg-[#EEF2FF] hover:text-[#6366F1]",
                      isToday && !isSelected && "ring-1 ring-[#6366F1]/40",
                      isDisabled &&
