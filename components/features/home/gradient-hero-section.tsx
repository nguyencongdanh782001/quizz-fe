...
const quickActions = [
  {
    ...
    label: "Lam bai thi",
    icon: BookOpen,
    desc: "Kham pha de thi",
  },
  {
    href: "/classes",
    label: "Lop hoc",
    icon: GraduationCap,
    desc: "Xem lop cua ban",
  },
    ...
    <section className="relative overflow-hidden rounded-2xl bg-gradient-hero p-8 md:p-12 mb-8">
      ...
      <div className="relative z-10 max-w-2xl">
        <h1 className="font-display font-bold text-2xl md:text-3xl text-white mb-3 leading-tight">
          Xin chào, {user?.full_name ?? "Hoc sinh"}
        </h1>
        <p className="text-white/80 text-base mb-6 leading-relaxed">
          Chào mừng bạn quay trở lại QuizzVn. Hôm nay bạn muốn ôn tập gì?
        </p>
