...
import { GraduationCap, BookOpen, History, Library } from 'lucide-react';
import { useAuth } from '@/hooks/useAuth';
import { cn } from '@/lib/utils';

const quickActions = [
  { href: '/exams', label: 'Làm bài thi', icon: BookOpen, desc: 'Khám phá đề thi' },
  { href: '/classes', label: 'Lớp học', icon: GraduationCap, desc: 'Xem lớp của bạn' },
  { href: '/history', label: 'Lịch sử', icon: History, desc: 'Kết quả thi' },
  { href: '/documents', label: 'Tài liệu', icon: Library, desc: 'Tài nguyên học tập' },
];
    ...
    <section className="relative overflow-hidden rounded-2xl bg-gradient-hero p-8 md:p-12 mb-8">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-white/80 text-base mb-6 leading-relaxed">
          Chào mừng bạn quay trở lại Scholar Clarity.
          Hôm nay bạn muốn ôn tập gì?
        </p>
