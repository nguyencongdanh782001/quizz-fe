              ...
              visibleExams.map((exam) => (
                ...
                >
                  <td className="px-3.5 py-2.5">
                    <p className="font-medium text-[#111827]">{exam.title}</p>
                  ...
                  <td className="px-3.5 py-2.5 text-[#526079]">
                    {formatScore(exam.totalPoints ?? exam.passingScore)}
                  </td>
                  <td className="px-3.5 py-2.5">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            ...
                            variant="ghost"
                            size="icon"
                            className="size-8 rounded-[6px] text-[#64748B] transition-colors hover:bg-[#EEF2FF] hover:text-[#4050DC]"
                            aria-label={`Thao tác với ${exam.title}`}
                          >
