    ...
    try {
      ...
      if (selectedAvatarFile) {
        try {
          ...
          showToast(
            "warning",
            APP_MESSAGES.UPLOAD_AVATAR_FAILED,
            "Tài khoản của bạn vẫn được tạo thành công và bạn có thể cập nhật ảnh trong Hồ sơ sau.",
          );
        ...
        {({
          ...
          <Form className="space-y-4">
            ...
            <AvatarUploadField
              ...
              onSelectedFileChange={setSelectedAvatarFile}
              helperText="Avatar là tuỳ chọn. Nếu bạn không chọn ảnh, hệ thống sẽ dùng chữ cái đầu của tên bạn."
            ...
            <button
              type="submit"
              disabled={isSubmitting || uploadAvatarMutation.isPending}
              className={cn(
                "cursor-pointer w-full py-3 rounded-xl font-semibold text-base",
